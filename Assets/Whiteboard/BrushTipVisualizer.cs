...
public class BrushTipVisualizer : MonoBehaviour
{
    ...
    [SerializeField] private BrushContext brushContext;
    ...
    private void Start()
    {
        previous3DMode = brushContext.is3DMode;
        ...
        sphereRenderer.material = new Material(brushContext.linePrefab.material);
    ...
    private void Update()
    {
        if (brushContext.is3DMode != previous3DMode)
        {
            tipSphere.SetActive(brushContext.is3DMode);
            previous3DMode = brushContext.is3DMode;
        }

        if (!brushContext.is3DMode) return;
    ...
    private void UpdateSize()
    {
        ...
        float normalized = Mathf.InverseLerp(1f, 100f, brushContext.brushSettings.BrushSize);
    ...
    {
        sphereRenderer.material.color = brushContext.brushSettings.BrushColor;
    }
}
